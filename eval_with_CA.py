...
test_data_filename = str(sys.argv[3])
...
x, y_poison = data_loader(test_data_filename)
...
print('\n')
print('\n')
print(f'Poison/clean labels where 0 is poison and 1 is clean =\n {y_pred}')
print('\n')
print('\n')
print(f'Detected labels = {y_pred_actual}')
